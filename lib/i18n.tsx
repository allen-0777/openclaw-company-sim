...
const translations: Record<Locale, Record<string, string>> = {
  "zh-TW": {
    ...
    "nav.config": "設定",
    "nav.skills": "技能管理",
    "config.title": "OpenClaw 系統設定",
    "config.visual": "視覺化編輯",
    "config.json": "JSON 編輯",
    "config.save": "儲存變更",
    "config.saving": "儲存中...",
    "config.saveSuccess": "設定已儲存！",
    "config.invalidJson": "JSON 格式錯誤，已切換至 JSON 模式。",
    "config.gateway": "閘道設定",
    "config.gatewayPort": "埠號",
    "config.gatewayToken": "認證 Token",
    "config.gatewayTokenPlaceholder": "(選填)",
    "config.agents": "機器人列表",
    "config.addAgent": "+ 新增機器人",
    "config.deleteAgent": "刪除",
    "config.confirmDelete": "確定要刪除此機器人嗎？",
    "config.agentId": "ID",
    "config.agentName": "名稱",
    "config.agentEmoji": "Emoji",
    "config.agentModel": "模型",
    "config.noAgents": "未定義任何機器人。點擊「+ 新增機器人」建立一個。",
    "config.models": "模型提供者",
    "config.addProvider": "+ 新增提供者",
    "config.deleteProvider": "刪除",
    "config.confirmDeleteProvider": "確定要刪除此提供者嗎？",
    "config.enterProviderId": "請輸入提供者 ID (例如: openai, anthropic, ollama):",
    "config.modelApi": "API 端點 (Base URL)",
    "config.providerKey": "API Key",
    "config.providerKeyHint": "您的 API Key 將安全儲存於本地設定檔中。",
    "config.noProviders": "尚未設定任何模型提供者。點擊「+ 新增提供者」開始設定。",
    "config.testProvider": "測試連線",
    "config.testingProvider": "測試中...",
    "config.testProviderSuccess": "連線成功！",
    "config.testProviderFail": "連線失敗",
    "config.resetDefault": "重置為預設值",
    "config.confirmReset": "這將使用預設範本覆蓋您目前的設定。確定要繼續嗎？",
    "nav.alerts": "警報中心",
    ...
    "gateway.setupTitle": "Gateway 尚未安裝",
    "gateway.setupDesc": "偵測不到 openclaw 指令，請選擇安裝方式：",
    "gateway.copyCommand": "複製安裝指令",
    "gateway.commandCopied": "已複製！",
  ...
  "zh": {
    ...
    "nav.config": "配置",
    "nav.skills": "技能管理",
    "config.title": "OpenClaw 系统设置",
    "config.visual": "可视化编辑",
    "config.json": "JSON 编辑",
    "config.save": "保存变更",
    "config.saving": "保存中...",
    "config.saveSuccess": "设置已保存！",
    "config.invalidJson": "JSON 格式错误，已切换至 JSON 模式。",
    "config.gateway": "网关设置",
    "config.gatewayPort": "端口",
    "config.gatewayToken": "认证 Token",
    "config.gatewayTokenPlaceholder": "(选填)",
    "config.agents": "机器人列表",
    "config.addAgent": "+ 新增机器人",
    "config.deleteAgent": "删除",
    "config.confirmDelete": "确定要删除此机器人吗？",
    "config.agentId": "ID",
    "config.agentName": "名称",
    "config.agentEmoji": "Emoji",
    "config.agentModel": "模型",
    "config.noAgents": "未定义任何机器人。点击“+ 新增机器人”创建一个。",
    "config.models": "模型提供者",
    "config.addProvider": "+ 新增提供者",
    "config.deleteProvider": "删除",
    "config.confirmDeleteProvider": "确定要删除此提供者吗？",
    "config.enterProviderId": "请输入提供者 ID (例如: openai, anthropic, ollama):",
    "config.modelApi": "API 端点 (Base URL)",
    "config.providerKey": "API Key",
    "config.providerKeyHint": "您的 API Key 将安全存储于本地配置文件中。",
    "config.noProviders": "尚未配置任何模型提供者。点击“+ 新增提供者”开始配置。",
    "config.testProvider": "测试连接",
    "config.testingProvider": "测试中...",
    "config.testProviderSuccess": "连接成功！",
    "config.testProviderFail": "连接失败",
    "config.resetDefault": "重置为默认值",
    "config.confirmReset": "这将使用默认模板覆盖您当前的设置。确定要继续吗？",
    "nav.alerts": "告警中心",
    ...
    "gateway.setupTitle": "Gateway 尚未安装",
    "gateway.setupDesc": "检测不到 openclaw 命令，请选择安装方式：",
    "gateway.copyCommand": "复制安装指令",
    "gateway.commandCopied": "已复制！",
  ...
  "en": {
    ...
    "nav.config": "Config",
    "nav.skills": "Skills",
    "config.title": "OpenClaw Settings",
    "config.visual": "Visual Editor",
    "config.json": "JSON Editor",
    "config.save": "Save Changes",
    "config.saving": "Saving...",
    "config.saveSuccess": "Configuration saved successfully!",
    "config.invalidJson": "Invalid JSON detected. Switched to JSON mode.",
    "config.gateway": "Gateway",
    "config.gatewayPort": "Port",
    "config.gatewayToken": "Auth Token",
    "config.gatewayTokenPlaceholder": "(Optional)",
    "config.agents": "Agents",
    "config.addAgent": "+ Add Agent",
    "config.deleteAgent": "Delete",
    "config.confirmDelete": "Delete this agent?",
    "config.agentId": "ID",
    "config.agentName": "Name",
    "config.agentEmoji": "Emoji",
    "config.agentModel": "Model",
    "config.noAgents": "No agents defined. Click \"+ Add Agent\" to create one.",
    "config.models": "Model Providers",
    "config.addProvider": "+ Add Provider",
    "config.deleteProvider": "Delete",
    "config.confirmDeleteProvider": "Delete this provider?",
    "config.enterProviderId": "Enter Provider ID (e.g., openai, anthropic, ollama):",
    "config.modelApi": "API Endpoint (Base URL)",
    "config.providerKey": "API Key",
    "config.providerKeyHint": "Your API Key will be stored securely in the local config file.",
    "config.noProviders": "No providers configured. Click \"+ Add Provider\" to start.",
    "config.testProvider": "Test Connection",
    "config.testingProvider": "Testing...",
    "config.testProviderSuccess": "Connected!",
    "config.testProviderFail": "Connection Failed",
    "config.resetDefault": "Reset to Default",
    "config.confirmReset": "This will overwrite your current configuration with the default template. Are you sure?",
    "nav.alerts": "Alerts",
    ...
    "gateway.setupTitle": "Gateway Not Installed",
    "gateway.setupDesc": "openclaw command not found. Choose installation method:",
    "gateway.copyCommand": "Copy Command",
