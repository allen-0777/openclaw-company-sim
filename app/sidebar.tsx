...
type NavIconName = "agents" | "pixelOffice" | "models" | "sessions" | "stats" | "alerts" | "skills" | "settings";
    ...
    case "settings":
      return (
        <PixelSvg
          ...
          palette={palette}
          pixels={[
            { x: 6, y: 2, w: 4, h: 12, tone: "base" },
            { x: 2, y: 6, w: 12, h: 4, tone: "base" },
            { x: 5, y: 5, w: 6, h: 6, tone: "shade" },
            { x: 7, y: 7, w: 2, h: 2, tone: "light" },
            { x: 7, y: 1, w: 2, h: 1, tone: "light" },
            { x: 1, y: 7, w: 1, h: 2, tone: "light" },
            { x: 14, y: 7, w: 1, h: 2, tone: "shade" },
            { x: 7, y: 14, w: 2, h: 1, tone: "shade" },
          ]}
        />
      );
  }
...
const NAV_ITEMS: { group: string; items: { href: string; icon: NavIconName; labelKey: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/config", icon: "settings", labelKey: "nav.settings" },
    ],
  },
];
